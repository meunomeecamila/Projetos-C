...
O código a seguir se inicia conferindo se o total pedido for difernte do total original. Caso seja, não é posivel fazer o que
foi pedido e por isso retorna a matriz como estava. 
Depois, a matriz res recebe os elementos da matriz original, porém a linha da matriz res do contador dividido por colunas 
receberá o contador dividido por colunas da original, enquanto as colunas da matriz res com o contador % pelas colunas
receberão o contador % pelas colunas da matriz original. 
*/
